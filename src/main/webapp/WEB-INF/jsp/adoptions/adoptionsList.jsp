	...
	<table id="adoptionTable" class="table table-striped ownersHead" >
      ...
      <tbody>
        <c:forEach items="${adoptions}" var="adoption">
            <tr>
                ...
                <td>
                    <spring:url value="/adoptions/details/{adoptionId}" var="adoptionUrl">
                        <spring:param name="adoptionId" value="${adoption.id}"/>
                    </spring:url>
                    <a href="${fn:escapeXml(adoptionUrl)}" class="btn btn-default">Detalles</a>
                </td>
     ...
     <h2>
     	<sec:authorize access="hasAuthority('owner')">
        	<a href="/adoptions/new" class="btn  btn-success">
        	<span class="glyphicon glyphicon-plus" aria-hidden="true">
			</span>Añadir Adopción</a>
       	</sec:authorize>
    </h2>
