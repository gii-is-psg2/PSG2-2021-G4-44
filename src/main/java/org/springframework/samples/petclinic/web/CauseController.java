...
public class CauseController {
    ...
    public String processCreationForm(@PathVariable("id") int id,@Valid Donation donation, BindingResult result,ModelMap model) {
        ...
        donation.setId(causeService.findCauses().size() + 1);
	...
	@PostMapping("/causes/new")
	public String processCreationCauseForm(@Valid Cause cause, BindingResult binding,ModelMap model) {
